...
1) Надо вспомнить про хеш-таблицы/их виды. Привести примеры хотя бы 3 хеш-функций
2) Что такое шифрование, которое использует соль?
3) Что такое принцип Керкгоффса?
